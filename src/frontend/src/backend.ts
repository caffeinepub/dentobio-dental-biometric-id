...
export class Backend implements backendInterface {
    ...
    async addIdentificationRecord(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addIdentificationRecord(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllIdentificationRecords(): Promise<Array<IdentificationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllIdentificationRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
